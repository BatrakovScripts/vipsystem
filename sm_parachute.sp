...
new bool:ActiveKey[MAXPLAYERS+1];
new g_iVelocity = -1;
new g_iMoney = -1;
new g_maxplayers = -1;
...
public OnPluginStart()
{
	...
	RegAdminCmd("sm_parachut", sm_parachut, ADMFLAG_CUSTOM1, "sm_vip");
...
public Action:sm_parachut(client, args)
{
	if(ActiveKey[client] == false)
	{
		ActiveKey[client] = true;
		PrintToChat(client,"\x05Парашут активирован");
	}
	else if(ActiveKey[client] == true)
	{
		ActiveKey[client] = false;
		PrintToChat(client,"\x04Парашут деактивирован");
	}
